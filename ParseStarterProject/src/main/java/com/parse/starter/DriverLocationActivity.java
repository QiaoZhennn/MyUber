                        ...
                        for (ParseObject object : objects) {
                            ...
                            object.saveInBackground(new SaveCallback() {
                                ...
                                public void done(ParseException e) {
                                    ...
                                    if (e == null) {
                                        double sLat = intent.getDoubleExtra("driverLatitude",0);
                                        double sLon = intent.getDoubleExtra("driverLongitude",0);
                                        double dLat = intent.getDoubleExtra("requestLatitude",0);
                                        double dLon = intent.getDoubleExtra("requestLongitude",0);
